...
DISTRO=fedora-server.42-aarch64
...
#FASTHDDEV="-device virtio-blk-pci,drive=hd0,id=hd0pci -drive if=virtio,file=$BOOTDISK,format=qcow2,drive=hd0"
...
URL="https://mirror.lstn.net/fedora/releases/42/Server/aarch64/iso/Fedora-Server-dvd-aarch64-42-1.1.iso"
JOBS=80
